...
const MESSAGES = {
  en: {
    ...
    home_stat_exams_label: 'Exams Taken',
    home_stat_exams_change: '{count} attempts',
    home_stat_exams_empty: 'Solve an exam!',
    home_points_breakdown_title: 'How points are earned',
    home_points_breakdown_quizzes: 'Each quiz created',
    home_points_breakdown_completed: 'Each PDF marked completed',
    home_points_breakdown_exam_base: 'Each exam attempt',
    home_points_breakdown_exam_bonus: 'Up to 50 bonus pts per exam based on accuracy',
    home_leaderboard_title: 'Leaderboard',
    home_leaderboard_subtitle: 'Top learners by total points',
    home_leaderboard_empty: 'No data yet. Be the first on the board!',
    home_leaderboard_you: 'You',
    home_leaderboard_view_more: 'View more',
    home_leaderboard_your_rank: 'Your rank: #{rank}',
    home_leaderboard_loading: 'Loading leaderboard...',
    home_leaderboard_col_rank: 'Rank',
    home_leaderboard_col_name: 'Name',
    home_leaderboard_col_points: 'Points',
  ...
  tr: {
    ...
    home_stat_exams_label: 'Çözülen Sınavlar',
    home_stat_exams_change: '{count} deneme',
    home_stat_exams_empty: 'Bir sınav çöz!',
    home_points_breakdown_title: 'Puanlar nasıl kazanılır',
    home_points_breakdown_quizzes: 'Oluşturulan her quiz',
    home_points_breakdown_completed: 'Tamamlanan her PDF',
    home_points_breakdown_exam_base: 'Her sınav denemesi',
    home_points_breakdown_exam_bonus: 'Doğruluk oranına göre sınav başına 50 puana kadar bonus',
    home_leaderboard_title: 'Sıralama Tablosu',
    home_leaderboard_subtitle: 'Toplam puana göre en iyi öğrenciler',
    home_leaderboard_empty: 'Henüz veri yok. Tabloda ilk olma sırası sende!',
    home_leaderboard_you: 'Sen',
    home_leaderboard_view_more: 'Daha fazla gör',
    home_leaderboard_your_rank: 'Sıran: #{rank}',
    home_leaderboard_loading: 'Sıralama yükleniyor...',
    home_leaderboard_col_rank: 'Sıra',
    home_leaderboard_col_name: 'İsim',
    home_leaderboard_col_points: 'Puan',
