    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-black flex overflow-hidden">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          >
            Start Your
            <span className="block">Learning Journey Today</span>
          </motion.h1>
          ...
          >
            Join thousands of students using AI to learn smarter and faster.
          </motion.p>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <p className="text-gray-900 dark:text-white font-medium mb-1">
                  "This platform transformed my study habits completely!"
                </p>
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  - Alex M., Engineering Student
                </p>
              </div>
            </div>
          </div>
            ...
            >
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`block w-full pl-10 pr-3 py-3 bg-white dark:bg-zinc-800 border ${
                        errors.firstName ? 'border-red-500' : 'border-gray-300 dark:border-zinc-700'
                        ...
                        errors.firstName ? 'bg-red-50 dark:bg-red-900/20' : ''
                      }`}
                ...
                >
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleChange}
                      className={`block w-full pl-4 pr-3 py-3 bg-white dark:bg-zinc-800 border ${
                        errors.lastName ? 'border-red-500' : 'border-gray-300 dark:border-zinc-700'
                      } rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-white focus:border-transparent transition-all text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 ${
                        errors.lastName ? 'bg-red-50 dark:bg-red-900/20' : ''
                      }`}
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`block w-full pl-10 pr-10 py-3 bg-white dark:bg-zinc-800 border ${
                      ...
                      errors.confirmPassword ? 'bg-red-50 dark:bg-red-900/20' : ''
                    }`}
              ...
              >
                <div className="flex items-start">
                  <input
                    ...
                    onChange={handleChange}
                    className={`h-4 w-4 text-blue-600 dark:text-white focus:ring-blue-500 dark:focus:ring-white border-gray-300 dark:border-zinc-700 rounded cursor-pointer mt-1 bg-white dark:bg-zinc-800 ${
                      errors.acceptTerms ? 'border-red-500' : ''
                    }`}
                  />
                  <label htmlFor="acceptTerms" className="ml-2 block text-sm text-gray-700 dark:text-gray-300 cursor-pointer">
                    I agree to the{' '}
                    <a href="#" className="text-blue-600 dark:text-white hover:text-blue-700 dark:hover:text-gray-300 font-medium">
                      Terms of Service
                    </a>{' '}
                    and{' '}
                    <a href="#" className="text-blue-600 dark:text-white hover:text-blue-700 dark:hover:text-gray-300 font-medium">
              ...
              >
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white dark:bg-zinc-900 text-gray-500 dark:text-gray-400">Or sign up with</span>
                </div>
              </motion.div>
