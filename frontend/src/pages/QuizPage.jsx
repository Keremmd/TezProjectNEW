    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 text-xl mb-4">Quiz not found</p>
          <button
          ...
          {!showResults ? (
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <button
                  ...
                  className="px-6 py-3 bg-zinc-800 text-white rounded-lg hover:bg-zinc-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
                >
            ...
            >
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-12 mb-8">
                ...
                <p className="text-gray-400 mb-8">Here are your results</p>
                ...
                <div className="grid grid-cols-3 gap-6 mb-8">
                  ...
                  <div className="bg-zinc-800 rounded-xl p-6">
                    ...
                    <p className="text-3xl font-bold text-blue-400">{formatTime(timeElapsed)}</p>
                  </div>
                </div>
